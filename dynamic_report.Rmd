...
print(paste("Minimum piercings: ", min_piercings))
print(paste("Maximum piercings: ", max_piercings))
print(paste("Average piercings: ", mean_piercings))
...
labs(title = "piercing types frequency", x = "types of piercings", y = "frequency")
